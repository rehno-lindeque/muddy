...
var $author$project$Main$init = {hovering: _List_Nil};
...
var $author$project$Main$Datum = F7(
	function (x, y, z, v, w, p, q) {
		return {p: p, q: q, v: v, w: w, x: x, y: y, z: z};
	});
var $author$project$Main$data = _List_fromArray(
	[
		A7($author$project$Main$Datum, 1, 2, 1, 4.6, 6.9, 7.3, 8.0),
		A7($author$project$Main$Datum, 2, 3, 2, 5.2, 6.2, 7.0, 8.7),
		A7($author$project$Main$Datum, 3, 4, 3, 5.5, 5.2, 7.2, 8.1),
		A7($author$project$Main$Datum, 4, 3, 4, 5.3, 5.7, 6.2, 7.8),
		A7($author$project$Main$Datum, 5, 2, 3, 4.9, 5.9, 6.7, 8.2),
		A7($author$project$Main$Datum, 6, 4, 1, 4.8, 5.4, 7.2, 8.3),
		A7($author$project$Main$Datum, 7, 5, 2, 5.3, 5.1, 7.8, 7.1),
		A7($author$project$Main$Datum, 8, 6, 3, 5.4, 3.9, 7.6, 8.5),
		A7($author$project$Main$Datum, 9, 5, 4, 5.8, 4.6, 6.5, 6.9),
		A7($author$project$Main$Datum, 10, 4, 3, 4.5, 5.3, 6.3, 7.0)
	]);
...
var $terezka$elm_charts$Chart$Attributes$gradient = function (colors) {
	return $terezka$elm_charts$Internal$Helpers$Attribute(
		function (config) {
			return _Utils_update(
				config,
		...
		function (list, toYs, result) {
			...
			while (true) {
				if (list.b) {
					var config = list.a;
					var rest = list.b;
					var toYs_ = A2($elm$core$List$cons, config.toY, toYs);
					var $temp$list = rest,
						$temp$toYs = toYs_,
						$temp$result = A2(
						$elm$core$List$cons,
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Chart.Item.Any":{"args":[],"type":"Internal.Item.Any"},"Main.Datum":{"args":[],"type":"{ x : Basics.Float, y : Basics.Float, z : Basics.Float, v : Basics.Float, w : Basics.Float, p : Basics.Float, q : Basics.Float }"},"Internal.Property.Identification":{"args":[],"type":"{ stackIndex : Basics.Int, seriesIndex : Basics.Int, absoluteIndex : Basics.Int, dataIndex : Basics.Int, elementIndex : Basics.Int }"},"Chart.Item.Many":{"args":["data","x"],"type":"Internal.Many.Many (Chart.Item.One data x)"},"Internal.Many.Many":{"args":["x"],"type":"Internal.Item.Rendered ( x, List.List x )"},"Chart.Item.One":{"args":["data","x"],"type":"Internal.Item.One data x"},"Internal.Item.One":{"args":["data","x"],"type":"Internal.Item.Rendered { presentation : x, color : String.String, datum : data, x1 : Basics.Float, x2 : Basics.Float, y : Basics.Float, isReal : Basics.Bool, tooltipText : String.String, name : Maybe.Maybe String.String, identification : Internal.Property.Identification, toAny : x -> Internal.Item.Any }"},"Svg.Attribute":{"args":["msg"],"type":"VirtualDom.Attribute msg"},"Internal.Coordinates.Axis":{"args":[],"type":"{ length : Basics.Float, marginMin : Basics.Float, marginMax : Basics.Float, dataMin : Basics.Float, dataMax : Basics.Float, min : Basics.Float, max : Basics.Float }"},"Internal.Svg.Bar":{"args":[],"type":"{ roundTop : Basics.Float, roundBottom : Basics.Float, color : String.String, border : String.String, borderWidth : Basics.Float, opacity : Basics.Float, design : Maybe.Maybe Internal.Svg.Design, attrs : List.List (Svg.Attribute Basics.Never), highlight : Basics.Float, highlightWidth : Basics.Float, highlightColor : String.String }"},"Internal.Svg.Dot":{"args":[],"type":"{ color : String.String, opacity : Basics.Float, size : Basics.Float, border : String.String, borderWidth : Basics.Float, highlight : Basics.Float, highlightWidth : Basics.Float, highlightColor : String.String, shape : Maybe.Maybe Internal.Svg.Shape, hideOverflow : Basics.Bool }"},"Html.Html":{"args":["msg"],"type":"VirtualDom.Node msg"},"Internal.Coordinates.Plane":{"args":[],"type":"{ x : Internal.Coordinates.Axis, y : Internal.Coordinates.Axis }"},"Internal.Coordinates.Position":{"args":[],"type":"{ x1 : Basics.Float, x2 : Basics.Float, y1 : Basics.Float, y2 : Basics.Float }"},"Svg.Svg":{"args":["msg"],"type":"VirtualDom.Node msg"},"Internal.Svg.Pattern":{"args":[],"type":"{ color : String.String, width : Basics.Float, spacing : Basics.Float, rotate : Basics.Float }"}},"unions":{"Main.Msg":{"args":[],"tags":{"OnHover":["List.List (Chart.Item.Many Main.Datum Chart.Item.Any)"]}},"Internal.Item.Any":{"args":[],"tags":{"Dot":["Internal.Svg.Dot"],"Bar":["Internal.Svg.Bar"],"Custom":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Internal.Item.Rendered":{"args":["meta"],"tags":{"Rendered":["meta","{ limits : Internal.Coordinates.Position, toPosition : Internal.Coordinates.Plane -> Internal.Coordinates.Position, render : Internal.Coordinates.Plane -> Internal.Coordinates.Position -> Svg.Svg Basics.Never, tooltip : () -> List.List (Html.Html Basics.Never) }"]}},"String.String":{"args":[],"tags":{"String":[]}},"VirtualDom.Attribute":{"args":["msg"],"tags":{"Attribute":[]}},"Internal.Svg.Design":{"args":[],"tags":{"Striped":["List.List (Internal.Helpers.Attribute Internal.Svg.Pattern)"],"Dotted":["List.List (Internal.Helpers.Attribute Internal.Svg.Pattern)"],"Gradient":["List.List String.String"]}},"Basics.Never":{"args":[],"tags":{"JustOneMore":["Basics.Never"]}},"VirtualDom.Node":{"args":["msg"],"tags":{"Node":[]}},"Internal.Svg.Shape":{"args":[],"tags":{"Circle":[],"Triangle":[],"Square":[],"Diamond":[],"Cross":[],"Plus":[]}},"Internal.Helpers.Attribute":{"args":["c"],"tags":{"Attribute":["c -> c"]}}}}})}});}(this));
